...
* **7. islower**
OBOBOB  * [7-islower.py](./7-islower.py): Python function that checks for lowercase characters.
OBOBOBOBOBOB  * Returns `True` if `c` is lowercase, `False` otherwise.
...
OBOBOBOBOBOB  digit of a number.
  * Returns the value of the last digit.
OBOBOB  * Without importing modules.
OBOBOB
* **10. a + b**
